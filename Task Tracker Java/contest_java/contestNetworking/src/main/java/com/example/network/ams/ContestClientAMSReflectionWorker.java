...
public class ContestClientAMSReflectionWorker implements Runnable {
    ...
    public ContestClientAMSReflectionWorker(IContestServiceAMS server, Socket connection) {
        this.server = server;
    ...
    private Response handleRequest(Request request) throws IOException {
        ...
        String handler = "handle" + (request).type();
        System.out.println("Handler " + handler);
        try {
            Method method = this.getClass().getDeclaredMethod(handler, Request.class);
            response = (Response) method.invoke(this, request);
            System.out.println("Method " + handler + " invoked");
